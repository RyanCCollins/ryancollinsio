...
const techStack = [
  ...
  },
  {
    label: "Middle End",
    value: "GraphQL",
    description: "A product-centric, declarative data fetching mechanism for your client-side web applications, GraphQL is transforming how we think about the client server relationship.",
    url: "https://github.com/RyanCCollins/cdn/blob/master/portfolio-image-gallery-images/techstack/graphql-logo.png?raw=true",
  },
  {
    label: "Back End",
    value: "Ruby on Rails",
